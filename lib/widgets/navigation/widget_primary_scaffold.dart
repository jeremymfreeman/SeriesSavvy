...
class _WidgetPrimaryScaffoldState extends ConsumerState<WidgetPrimaryScaffold> {
  ...
  Widget _getAppBarTitle(int currentTabIndex) {
    if (currentTabIndex == BottomNavSelection.HOME_SCREEN.index)
      return Text("Shows", style: TextStyle(color: Colors.white));
    else
      return Text("Your Friends Reviews", style: TextStyle(color: Colors.white));
  }
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: [
          BottomNavigationBarItem(
            label: "Shows",
            activeIcon: Icon(FontAwesomeIcons.tv, color: Colors.white),
            icon: Icon(FontAwesomeIcons.tv, color: Colors.white),
            backgroundColor: Colors.white, // Change text color to white
          ),
            BottomNavigationBarItem(
            label: "Reviews",
            activeIcon: Icon(FontAwesomeIcons.solidStar, color: Colors.white),
            icon: Icon(FontAwesomeIcons.solidStar, color: Colors.white),
            backgroundColor: Colors.white, // Change text color to white
          ),
        ],
      ),
