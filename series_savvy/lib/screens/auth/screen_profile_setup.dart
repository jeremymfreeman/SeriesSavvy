...
class _ScreenProfileSetupState extends ConsumerState<ScreenProfileSetup> {
  ...
  Widget build(BuildContext context) {
    ...
    decoration: InputDecoration(
      ...
      fillColor: Color(0xFF5E59D9), // Set the fill color to #5E59D9
      filled: true,
    ),
  ...
  children: [
    Padding(
      ...
      child: ElevatedButton(
        ...
        child: widget.isAuth
            ? const Text("Submit", style: TextStyle(color: Colors.white)) // Set the text color to white
            : const Text("Update", style: TextStyle(color: Colors.white)), // Set the text color to white
      ),
    ),
    if (widget.isAuth)
      Padding(
