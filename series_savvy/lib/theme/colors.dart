...
class CustomColors {
  ...
  static const Color primaryBackgroundLightMode = Color(0xFF4E5999); // Darker blue
  static const Color primaryBackgroundDarkMode = Color(0xFF4E5999); // Darker blue
  static const Color primaryNavBarLightMode = Color(0xFF4E5999); // Darker blue
  static const Color primaryNavBarDarkMode = Color(0xFF4E5999); // Darker blue
}
